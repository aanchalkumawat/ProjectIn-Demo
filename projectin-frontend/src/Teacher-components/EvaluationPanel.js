...
const EvaluationPanel = () => {
  ...
  {[...(team.teamMembers || []), {
    ...
    subject: team.teamLeader.subject,
    ...
    <tr key={member.enrollmentNumber}>
      <td>
        {member.enrollmentNumber}
        {member.isLeader && <span style={{ color: "blue" }}> (Leader)</span>}
      </td>
      <td>
        <input
          type="number"
          placeholder="Marks"
          value={
            evaluations[team._id]?.[member.enrollmentNumber]?.evaluation1 || ""
          }
          onChange={(e) =>
            handleEvaluationChange(
              team._id,
      ...
      <td>
        <button
          className="submit-btn"
          onClick={() =>
            handleEvaluation1Submit(team._id, member.enrollmentNumber)
          }
          disabled={
            !evaluations[team._id]?.[member.enrollmentNumber]?.evaluation1
          }
      ...
      <td>
        <input
          ...
          placeholder="Marks"
          value={
            evaluations[team._id]?.[member.enrollmentNumber]?.evaluation2 || ""
          }
          onChange={(e) =>
            handleEvaluationChange(
              team._id,
      ...
      <td>
        <button
          className="submit-btn"
          onClick={() =>
            handleEvaluation2Submit(team._id, member.enrollmentNumber)
          }
          disabled={
            !evaluations[team._id]?.[member.enrollmentNumber]?.evaluation2
          }
