  ...
  return (
    <>
      <div className="flashcards-container">
        <div className="flashcard" onClick={() => setIsSetLimitsOpen(true)}>
          <h3>Set Team and Mentor Limit</h3>
          <p>Configure the maximum number of team members and mentors per team.</p>
        </div>

        <div className="flashcard" onClick={() => setIsFreezePopupOpen(true)}>
          <h3>Freeze Team</h3>
      ...
      <div className="flashcards-container">
        <div className="flashcard" onClick={() => navigate("/coordinator-dashboard/panel-formation")}>
          <h3>Panel Formation</h3>
          <p>Create panels for evaluating student projects and assign members to each panel.</p>
        </div>

        <div className="flashcard" onClick={() => setIsEvaluatePopupOpen(true)}>
          <h3>Evaluate</h3>
